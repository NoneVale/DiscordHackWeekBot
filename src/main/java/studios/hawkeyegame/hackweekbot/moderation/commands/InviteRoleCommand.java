...
public class InviteRoleCommand implements CommandExecutor {
            ...
            switch (args.length) {
                ...
                case 2:
                    ...
                    if (role != null) {
                        if (args[0].equalsIgnoreCase("add")) {
                            if (serverModel.getInviteRoles().contains(role.getIdAsString())) {
                                EmbedBuilder roleAlreadyAdded = new EmbedBuilder()
                                        .setDescription("That role has already been added to the invite role list.")
                                        .setColor(serverModel.getColor())
                                        .setFooter(serverModel.getFooter())
                                        .setTimestamp(Instant.now());
                            ...
                            serverModel.addInviteRole(role.getIdAsString());
                            EmbedBuilder roleAdded = new EmbedBuilder()
                                    .setDescription(role.getMentionTag() + " has been added to the list of invite roles.")
                                    .setColor(serverModel.getColor())
                                    .setFooter(serverModel.getFooter())
                                    .setTimestamp(Instant.now());
                            ...
                            if (!serverModel.getInviteRoles().contains(role.getIdAsString())) {
                                EmbedBuilder roleNotAdded = new EmbedBuilder()
                                        .setDescription("That role is not in invite role list.")
                                        .setColor(serverModel.getColor())
                                        .setFooter(serverModel.getFooter())
                                        .setTimestamp(Instant.now());
                            ...
                            serverModel.removeInviteRole(role.getIdAsString());
                            EmbedBuilder roleRemoved = new EmbedBuilder()
                                    .setDescription(role.getMentionTag() + " has been removed from the list of invite roles.")
                                    .setColor(serverModel.getColor())
                                    .setFooter(serverModel.getFooter())
                                    .setTimestamp(Instant.now());
                ...
                default:
                    EmbedBuilder cmdInfo = new EmbedBuilder()
                            .setDescription(serverModel.getCommandPrefix() + "inviterole list \n"
                                    + serverModel.getCommandPrefix() + "inviterole add [role] \n"
                                    + serverModel.getCommandPrefix() + "inviterole remove [role]")
                            .setColor(serverModel.getColor())
                            .setFooter(serverModel.getFooter())
                            .setTimestamp(Instant.now());
