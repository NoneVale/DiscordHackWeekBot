...
public class VouchRoleCommand implements CommandExecutor {
            ...
            switch (args.length) {
                ...
                case 2:
                    ...
                    if (role != null) {
                        if (args[0].equalsIgnoreCase("add")) {
                            if (serverModel.getVouchRoles().contains(role.getIdAsString())) {
                                EmbedBuilder roleAlreadyAdded = new EmbedBuilder()
                                        .setDescription("That role has already been added to the vouch role list.")
                                        .setColor(serverModel.getColor())
                                        .setFooter(serverModel.getFooter())
                                        .setTimestamp(Instant.now());
                            ...
                            serverModel.addVouchRole(role.getIdAsString());
                            EmbedBuilder roleAdded = new EmbedBuilder()
                                    .setDescription(role.getMentionTag() + " has been added to the list of vouch roles.")
                                    .setColor(serverModel.getColor())
                                    .setFooter(serverModel.getFooter())
                                    .setTimestamp(Instant.now());
                            ...
                            if (!serverModel.getVouchRoles().contains(role.getIdAsString())) {
                                EmbedBuilder roleNotAdded = new EmbedBuilder()
                                        .setDescription("That role is not in vouch role list.")
                                        .setColor(serverModel.getColor())
                                        .setFooter(serverModel.getFooter())
                                        .setTimestamp(Instant.now());
                            ...
                            serverModel.removeVouchRole(role.getIdAsString());
                            EmbedBuilder roleRemoved = new EmbedBuilder()
                                    .setDescription(role.getMentionTag() + " has been removed from the list of vouch roles.")
                                    .setColor(serverModel.getColor())
                                    .setFooter(serverModel.getFooter())
                                    .setTimestamp(Instant.now());
                ...
                default:
                    EmbedBuilder cmdInfo = new EmbedBuilder()
                            .setDescription(serverModel.getCommandPrefix() + "vouchrole list \n"
                                    + serverModel.getCommandPrefix() + "vouchrole add [role] \n"
                                    + serverModel.getCommandPrefix() + "vouchrole remove [role]")
                            .setColor(serverModel.getColor())
                            .setFooter(serverModel.getFooter())
                            .setTimestamp(Instant.now());
